...
const ENGINE_VERSION='V-ZONE-TELEGRAM-V4';
const MARKET_PATH='/api/pre-market/mt5-authoritative';
...
async function market(){try{return normalizeMarket(await requestJson(MARKET_PATH));}catch(e){console.warn(`[V-ZONE TELEGRAM] MARKET BRIDGE ERROR | ${MARKET_PATH} | ${e.message}`);throw new Error(`MARKET_BRIDGE_FAILED | ${e.message}`);}}
