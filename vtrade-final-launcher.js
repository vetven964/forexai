// V-TRADE FINAL PRODUCTION LAUNCHER V6
...
const REQUIRED=['vtrade-enhanced-launcher.js','server-launcher.js','server.js','telegram-bot-ai-service-v6.js','telegram-v6-delivery-hotfix-v7.js','telegram-v8-startup-chat-test.js','telegram-signal-bridge.js','pre-market-ai-core.js','monday-fresh-candle-contract.js','package-access-hotfix.js','pre-market-route-boot-hotfix.js','ai-confirmation-runtime-v2.js','pre-market-structure-hook.js','predeploy-consistency-hotfix.js'];
...
try{validateProductionFiles();validateOwnership();require('./monday-fresh-candle-contract.js');require('./telegram-v6-delivery-hotfix-v7.js');require('./telegram-v8-startup-chat-test.js');console.log('[V-TRADE FINAL] Telegram V6 delivery + startup chat verification loaded');console.log('[V-TRADE FINAL] starting canonical 3-boundary ownership architecture');require('./vtrade-enhanced-launcher.js');}catch(e){console.error('[V-TRADE FINAL LAUNCHER] FATAL:',e.stack||e.message);process.exitCode=1;}
