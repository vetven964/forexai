...
['Phone shell loads V19 interaction + layout',phone.includes('phone-interaction=v19')&&phone.includes('vtrade-phone-interaction-v16.js?v=20260824-v19')&&phone.includes('vtrade-phone-layout-v1.css?v=20260824-v1')&&phone.includes('vtrade-phone-controls-v1.js?v=20260824-v16')],
...
['Phone controls support native V91 delegation',controls.includes("[data-v91tf=\\\"'+tf+'\\\"]")&&controls.includes('target.click()')],
['Old V17 bridge is prevented from intercepting',controls.includes('window.__VTRADE_PHONE_INTERACTION_V17__=true')],
