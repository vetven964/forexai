...
['enhanced launcher uses Telegram V4',enhanced.includes('telegram-bot-ai-service-v4.js')],
...
['Phone shell loads V15 controls',phone.includes('vtrade-phone-controls-v1.js?v=20260824-v15')],
['Phone shell loads V16 interaction',phone.includes('vtrade-phone-interaction-v16.js?v=20260824-v16')],
...
['V16 fetches authoritative MT5 data',interaction.includes('/api/pre-market/mt5-authoritative')],
['V16 fetches AI confirmation',interaction.includes('/api/pre-market/ai?tf=')],
['V16 binds selected TF to analyze()',interaction.includes('analyze(tf)')&&interaction.includes('TFS.includes(select.value)')],
['V16 phone-only guard',interaction.includes('max-width:900px')],
