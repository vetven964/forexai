// V-TRADE AI — Telegram compact signal formatter V5
...
const MARKER='VTRADE_TELEGRAM_COMPACT_FORMAT_V5';
...
function patch(){
  ...
  const replacement=String.raw`function formatSignal(a){
  // ${MARKER}
  ...
  console.log('[V-TRADE TELEGRAM] compact formatter V5 installed');
}
try{patch();}catch(e){console.error('[V-TRADE TELEGRAM] compact formatter V5 failed:',e.stack||e.message);throw e;}
