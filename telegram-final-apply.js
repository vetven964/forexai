// V-TRADE AI — final Telegram formatter apply hook V7.1
// Single final formatter entry point. Safe to load more than once.
'use strict';

try {
  const marker = '[V-TRADE TELEGRAM] final formatter V7.1 active';
  require('./telegram-final-format-hotfix.js');
  console.log(marker + ' | canonical MTF/ICT aliases | Khmer + English | fail-closed');
} catch (e) {
