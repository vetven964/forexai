...
// Automatic Telegram delivery is ENTRY-ONLY. Unauthorized WAIT remains silent.
...
// Remove any older periodic automatic WAIT delivery.
...
// Ensure diagnostic reasons are available when the guards block an entry.
...
// Keep the canonical V-ZoneAI Telegram output and protections.
if(!s.includes(OUT)){
...
// Add explicit Telegram bot authentication diagnostics.
...
console.log('[V-TRADE TELEGRAM] V-ZoneAI output V1 | ENTRY-ONLY | candleGuard scope fixed | RS/SP SL guard | no fake candle');
